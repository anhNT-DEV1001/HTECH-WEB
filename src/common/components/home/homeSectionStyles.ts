export const homeSectionTitleClass =
  "text-2xl sm:text-3xl lg:text-4xl font-bold uppercase tracking-tight text-[#1E0D01]";
...
export const homeCardBodyClass =
  "text-sm sm:text-base leading-relaxed text-[#1E0D01]/70";

export const homeHeroTitleClass =
  "text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-center text-[#1E0D01]";

export const homeHeroTaglineClass =
